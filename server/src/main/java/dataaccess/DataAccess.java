...
public interface DataAccess {
    ...
    List<GameData> listGames(String authToken) throws DataAccessException, UnauthorizedException;
    ...
    void updateGame(GameData gameData) throws DataAccessException, BadRequestException;
}
